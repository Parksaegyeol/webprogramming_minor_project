  ...
  <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
   ...
   <img src="images/세종대 로고.jpg"  style="width:5rem;"class="me-2">
    ...
    <ul class="nav nav-pills">
      <li class="nav-item"><a href="./index_login.php" class="nav-link active" aria-current="page">Home</a></li>
      <li class="nav-item"><a href="./edit.php" class="nav-link">내정보</a></li>
      <li class="nav-item"><a href="./index.php" class="nav-link">로그아웃</a></li>
